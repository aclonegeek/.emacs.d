(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spacemacs-theme dumb-jump use-package auto-complete flycheck pylint flx-ido rainbow-delimiters projectile all-the-icons-dired nlinum neotree multiple-cursors org)))
 '(server-mode t)
