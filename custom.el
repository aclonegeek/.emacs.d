(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (python-mode config test rust keybinds ui adsc smart-mode-line darktooth-theme dumb-jump use-package auto-complete flycheck pylint flx-ido rainbow-delimiters projectile all-the-icons-dired nlinum neotree multiple-cursors org)))
 '(server-mode t)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 95 :width normal :foundry "outline" :family "Droid Sans Mono")))))
