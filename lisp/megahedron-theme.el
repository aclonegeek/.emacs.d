;;; megahedron-theme.el --- Megahedron theme -*- lexical-binding: t; -*-

;; Copyright (C) 2023 Randy Taylor

;; Author: Randy Taylor
;; URL: https://git.sr.ht/~randy/.emacs.d/tree/master/item/lisp/megahedron-theme.el
;; Version: 0.0.1
...
(let* ((black "#000000")
       ...
       (bg "#1d212c") ;; TODO: Unsure about this.
       (fg "#bdbdbd")
       (darker-fg "#787878")
       (current-bg "#1f2424")
       (dialog-bg "#292929")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-operator-face                  ((t (:foreground ,blue-muted :bold t))))
...
(provide-theme 'megahedron)

;;; megahedron-theme.el ends here
